...
export const Icon = ({ name, size = 24, className = '' }: IconProps) => {
  const icons: Record<string, JSX.Element> = {
    wave: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M2 12c.6-2.3 2.5-4 5-4s4.4 1.7 5 4c.6 2.3 2.5 4 5 4s4.4-1.7 5-4" />
        <path d="M2 18c.6-2.3 2.5-4 5-4s4.4 1.7 5 4c.6 2.3 2.5 4 5 4s4.4-1.7 5-4" />
      </svg>
    ),
    pin: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return <span className={`icon ${className}`}>{icons[name] || icons.info}</span>;
};
